...
<img src="docs/framework.png" width="100%" alt="Diagram of Draft-based Approximate Inference Framework">
...
<details> <summary><strong>SpecKV-PC</strong> </summary>
...
*See more in [notebooks/example_usage_speckvpc.ipynb](notebooks/example_usage_speckvpc.ipynb).*
...
- [x] Release codebase for SpecKV-PC
