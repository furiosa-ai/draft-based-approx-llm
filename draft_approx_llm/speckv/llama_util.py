...
class LlamaAttentionSpecKV(LlamaAttention):
    def forward(
        self,
...
def update_llama_model_for_speckv(model):
    for i in range(len(model.model.layers)):
        model.model.layers[i].self_attn.forward = LlamaAttentionSpecKV.forward.__get__(
